...
public class RpgImd {
    ...
    public static void criarJogador() throws IOException, InterruptedException {
        ...
        switch (classeNumero) {
            ...
            case 3:
                ...
                break;
            case 999:
                jogador.setClasse("Capivara");
                break;
            default:
                jogador.setClasse("Aprendiz");
                break;
        }
    ...
    public static void imprimirCabecalho() throws IOException, InterruptedException {
        Ferramentas f = new Ferramentas();
        f.limparTela();
        for (int j = 0; j < 120; j++) {
            System.out.print("=");
